...
<nav class="navbar navbar-default">
 ...
 <!--bloque de alertas-->
        ...
        <div class="container">
            ...
            <form action="editar_productoscod.php?" method="POST" enctype="multipart/form-data">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                       ...
                       <div class="form-group">
                            ...
                            <input type="hidden" id="id" name="id" class="form-control" required="" min="0" max="1000" placeholder="Ingrese el id" value="<?=$producto->id?>">
                       		</div>
                            
                            <label for="categoria_id">Categoría</label>
                            <select name="categoria_id" id="categoria_id" class="form-control" required>
                            	<option value="<?=$producto->categorias_nombre?>" selected="" disabled=""><?=$producto->categorias_nombre?></option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" id="imagen" name="imagen" class="form-control" value="<?=$producto->imagen?>">
                            
                        </div>
                        
                        <input type="checkbox" name="estado" data-on-text="Activo" data-off-text="Inactivo" checked="" value="<?=$producto->estado?>">
